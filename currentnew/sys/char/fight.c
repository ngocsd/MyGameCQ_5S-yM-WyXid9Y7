...
{	
	...
	if (me->get_save("nguhanh") == 1 && who->is_user() && (who->get_save("nguhanh") == 2 &&
							       ((item1 = me->get_equip(WEAPON_TYPE)) && (item2 = me->get_equip(ARMOR_TYPE)) && (item3 = me->get_equip(HEAD_TYPE)) && (item4 = me->get_equip(NECK_TYPE)) && (item5 = me->get_equip(WAIST_TYPE)) && (item6 = me->get_equip(BOOTS_TYPE)) && (item1->get_nh() == 1) && (item2->get_nh() == 2) && (item3->get_nh() == 2) && (item4->get_nh() == 4) && (item5->get_nh() == 1) && (item6->get_nh() == 5))))
	{
		rate += 20; // kim -> mộc
	}
	if (rate < 1000)
...
*/
		...
		if (me->get_save("nguhanh") == 4 && who->is_user() && (who->get_save("nguhanh") == 5 &&
								       ((item1 = me->get_equip(WEAPON_TYPE)) && (item2 = me->get_equip(ARMOR_TYPE)) && (item3 = me->get_equip(HEAD_TYPE)) && (item4 = me->get_equip(NECK_TYPE)) && (item5 = me->get_equip(WAIST_TYPE)) && (item6 = me->get_equip(BOOTS_TYPE)) && item1->get_nh() == 4 && item2->get_nh() == 1 && item3->get_nh() == 5 && item4->get_nh() == 5 && item5->get_nh() == 3 && item6->get_nh() == 2)))
		{
			damage = damage * 115 / 100; // thuỷ -> hoả
		}
		if (me->is_zombie() && (ai = me->get_owner()) && ai->get_save("nguhanh") == 3 && who->is_user() && (who->get_save("nguhanh") == 4 &&
														    ((item1 = ai->get_equip(WEAPON_TYPE)) && (item2 = ai->get_equip(ARMOR_TYPE)) && (item3 = ai->get_equip(HEAD_TYPE)) && (item4 = ai->get_equip(NECK_TYPE)) && (item5 = ai->get_equip(WAIST_TYPE)) && (item6 = ai->get_equip(BOOTS_TYPE)) && item1->get_nh() == 3 && item2->get_nh() == 1 && item3->get_nh() == 2 && item4->get_nh() == 4 && item5->get_nh() == 1 && item6->get_nh() == 5)))
		{
		...
		if (me->get_save("nguhanh") == 1 && who->is_user() && (who->get_save("nguhanh") == 5 &&
								       ((item1 = who->get_equip(WEAPON_TYPE)) && (item2 = who->get_equip(ARMOR_TYPE)) && (item3 = who->get_equip(HEAD_TYPE)) && (item4 = who->get_equip(NECK_TYPE)) && (item5 = who->get_equip(WAIST_TYPE)) && (item6 = who->get_equip(BOOTS_TYPE)) && (item1->get_nh() == 5) && (item2->get_nh() == 3) && (item3->get_nh() == 1) && (item4->get_nh() == 2) && (item5->get_nh() == 4) && (item6->get_nh() == 2))))
		{
			damage = damage * 85 / 100; // kim -> hoả
		}
		if (me->get_save("nguhanh") == 4 && who->is_user() && (who->get_save("nguhanh") == 3 &&
								       ((item1 = who->get_equip(WEAPON_TYPE)) && (item2 = who->get_equip(ARMOR_TYPE)) && (item3 = who->get_equip(HEAD_TYPE)) && (item4 = who->get_equip(NECK_TYPE)) && (item5 = who->get_equip(WAIST_TYPE)) && (item6 = who->get_equip(BOOTS_TYPE)) && item1->get_nh() == 3 && item2->get_nh() == 1 && item3->get_nh() == 2 && item4->get_nh() == 4 && item5->get_nh() == 1 && item6->get_nh() == 5)))
		{
...
*/
		...
		if (me->get_save("nguhanh") == 2 && who->is_user() && (who->get_save("nguhanh") == 3 &&
								       ((item1 = me->get_equip(WEAPON_TYPE)) && (item7 = me->get_equip(ARMOR_TYPE)) && (item3 = me->get_equip(HEAD_TYPE)) && (item4 = me->get_equip(NECK_TYPE)) && (item5 = me->get_equip(WAIST_TYPE)) && (item6 = me->get_equip(BOOTS_TYPE)) && item1->get_nh() == 2 && item7->get_nh() == 4 && item3->get_nh() == 4 && item4->get_nh() == 5 && item5->get_nh() == 1 && item6->get_nh() == 3)))
		{
		...
		if (me->get_save("nguhanh") == 2 && who->is_user() && (who->get_save("nguhanh") == 1 &&
								       ((item1 = who->get_equip(WEAPON_TYPE)) && (item7 = who->get_equip(ARMOR_TYPE)) && (item3 = who->get_equip(HEAD_TYPE)) && (item4 = who->get_equip(NECK_TYPE)) && (item5 = who->get_equip(WAIST_TYPE)) && (item6 = who->get_equip(BOOTS_TYPE)) && item1->get_nh() == 1 && item7->get_nh() == 2 && item3->get_nh() == 2 && item4->get_nh() == 4 && item5->get_nh() == 1 && item6->get_nh() == 5)))
		{
...
*/
		...
		if (me->get_save("nguhanh") == 5 && who->is_user() && (who->get_save("nguhanh") == 1 &&
								       ((item1 = me->get_equip(WEAPON_TYPE)) && (item2 = me->get_equip(ARMOR_TYPE)) && (item3 = me->get_equip(HEAD_TYPE)) && (item4 = me->get_equip(NECK_TYPE)) && (item5 = me->get_equip(WAIST_TYPE)) && (item6 = me->get_equip(BOOTS_TYPE)) && item1->get_nh() == 5 && item2->get_nh() == 3 && item3->get_nh() == 1 && item4->get_nh() == 2 && item5->get_nh() == 4 && item6->get_nh() == 2)))
		{
			damage = damage * 115 / 100; // hoả -> kim
		}
		if (me->get_save("nguhanh") == 3 && who->is_user() && (who->get_save("nguhanh") == 4 &&
								       ((item1 = me->get_equip(WEAPON_TYPE)) && (item2 = me->get_equip(ARMOR_TYPE)) && (item3 = me->get_equip(HEAD_TYPE)) && (item4 = me->get_equip(NECK_TYPE)) && (item5 = me->get_equip(WAIST_TYPE)) && (item6 = me->get_equip(BOOTS_TYPE)) && item1->get_nh() == 3 && item2->get_nh() == 1 && item3->get_nh() == 2 && item4->get_nh() == 4 && item5->get_nh() == 1 && item6->get_nh() == 5)))
		{
		...
		if (me->get_save("nguhanh") == 3 && who->is_user() && (who->get_save("nguhanh") == 2 &&
								       ((item1 = who->get_equip(WEAPON_TYPE)) && (item2 = who->get_equip(ARMOR_TYPE)) && (item3 = who->get_equip(HEAD_TYPE)) && (item4 = who->get_equip(NECK_TYPE)) && (item5 = who->get_equip(WAIST_TYPE)) && (item6 = who->get_equip(BOOTS_TYPE)) && item1->get_nh() == 2 && item2->get_nh() == 4 && item3->get_nh() == 4 && item4->get_nh() == 5 && item5->get_nh() == 1 && item6->get_nh() == 3)))
		{
...
*/
		...
		if (me->get_save("nguhanh") == 5 && who->is_user() && (who->get_save("nguhanh") == 1 &&
								       ((item1 = me->get_equip(WEAPON_TYPE)) && (item7 = me->get_equip(ARMOR_TYPE)) && (item3 = me->get_equip(HEAD_TYPE)) && (item4 = me->get_equip(NECK_TYPE)) && (item5 = me->get_equip(WAIST_TYPE)) && (item6 = me->get_equip(BOOTS_TYPE)) && item1->get_nh() == 5 && item7->get_nh() == 3 && item3->get_nh() == 1 && item4->get_nh() == 2 && item5->get_nh() == 4 && item6->get_nh() == 2)))
		{
			damage = damage * 115 / 100; // hoả -> kim
		}
		if (p = who->get_skill(0433))
		...
		if (me->get_save("nguhanh") == 5 && who->is_user() && (who->get_save("nguhanh") == 4 &&
								       ((item1 = who->get_equip(WEAPON_TYPE)) && (item7 = who->get_equip(ARMOR_TYPE)) && (item3 = who->get_equip(HEAD_TYPE)) && (item4 = who->get_equip(NECK_TYPE)) && (item5 = who->get_equip(WAIST_TYPE)) && (item6 = who->get_equip(BOOTS_TYPE)) && item1->get_nh() == 4 && item7->get_nh() == 1 && item3->get_nh() == 5 && item4->get_nh() == 5 && item5->get_nh() == 3 && item6->get_nh() == 2)))
		{
