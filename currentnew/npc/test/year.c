    ...
    switch (flag) {
        ...
        case 12:
            if (who->get_save("csmm1") > 0 && who->get_save("csmm2") > 0) {
                ...
                if (abs(who->get_save("csmm1") - ben) < 11) {
                    tet1 = 1;
                    tet3 = who->get_save("csmmm")*10;
                }
                if (abs(who->get_save("csmm2") - ben) < 11) {
                    tet2 = 1;
                    tet4 = who->get_save("csmmm")*10;
                }
                if (tet1 == 1 && tet2 == 1) {
                    who->add_cash(tet3);
                    who->add_cash(tet4);
        ...
        case 17:
            if (flag == 14) {
                bennhat = "item/event/tuihoangkim";
                bennhat2 = 20;
                bn2 = 70;
            }// Tỉ lệ thành công trước là 10
            else if (flag == 15) {
                bennhat = "item/event/tuikimbao";
                bennhat2 = 15;
                bn2 = 70;
            }// Tỉ lệ thành công trước là 20
            else if (flag == 16) {
                bennhat = "item/event/tuinganluong";
                bennhat2 = 10;
                bn2 = 70;
            } // Tỉ lệ thành công trước là 20
