...
int perform_done(object me, object who)
{
        ...
        if (me->get_skill(THIS_SKILL) >= 61)
                char = get_range_object_2(me, 7, USER_TYPE) + get_range_object_2(me, 7, CHAR_TYPE) - ({me});
        else
                char = get_range_object_2(me, 5, USER_TYPE) + get_range_object_2(me, 5, CHAR_TYPE) - ({me});
